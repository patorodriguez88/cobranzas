...
//  $sql=$mysqli->query("SELECT NumeroCliente,Importe,Banco,Operacion FROM Cobranza_conciliacion WHERE id_cobranza='$dato'");
//  $row=$sql->fetch_array(MYSQLI_ASSOC);

 // Añade una nueva persona al fichero
//  $actual .= $_POST['id_cobranza'][$i].";".$row['NumeroCliente'].";".$row['Banco'].";".$row['Operacion'].";".$row['Importe']."\n";
